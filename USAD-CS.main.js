...
(function () {
    ...
    if (totalUnits < minimumRegularUnits) {
        unitDiv.innerHTML = `<div style="color: #664d03; background-color: #fff3cd; border: 1px solid #ffe69c; padding: 5px 6px; border-radius: 4px; margin-top: 5px; font-size: 13px; font-weight: bold;">⚠️ Underloaded: ${totalUnits} units (&lt; ${minimumRegularUnits.toFixed(1)})</div>`;
    } else if (totalUnits > maximumRegularUnits) {
        unitDiv.innerHTML = `<div style="color: #842029; background-color: #f8d7da; border: 1px solid #f5c2c7; padding: 5px 6px; border-radius: 4px; margin-top: 5px; font-size: 13px; font-weight: bold;">⚠️ Overloaded: ${totalUnits} units (&gt; ${maximumRegularUnits.toFixed(1)})</div>`;
    } else {
